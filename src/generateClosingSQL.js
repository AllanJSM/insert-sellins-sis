    ...
    rows.forEach((row, index) => {
        ...
        if (cleanCNPJ.length === 14 && typeof value === 'number' && !isNaN(value)) {
            ...
            const dateExpr = isLastYear
                ? "(date_trunc('month', CURRENT_DATE) - interval '12 month') - interval '1 day' + interval '14 hour'"
                : "date_trunc('month', CURRENT_DATE) - interval '1 day' + interval '14 hour'";
...
module.exports = generateClosingSQL;